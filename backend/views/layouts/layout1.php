        ...
        <ul class="nav pull-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?= Url::to(['manage/email-change'])?>">个人信息管理</a></li>
                    <li><a href="<?= Url::to(['manage/password-change'])?>">修改密码</a></li>
                    <li><a href="#">订单管理</a></li>
                </ul>
            </li>
    ...
    <ul id="dashboard-menu">
        ...
        <li>
            ...
            <ul class="submenu">
                ...
                <li><a href="<?= Url::to(['manage/create'])?>">加入新管理员</a></li>
            </ul>
        </li>
        <li>
            <a class="dropdown-toggle" href="#">
            ...
            <ul class="submenu">
                ...
                <li><a href="<?= Url::to(['user/create'])?>">加入新用户</a></li>
            </ul>
        </li>
        <li>
            <a class="dropdown-toggle" href="#">
